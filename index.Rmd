...
This webpage aims at providing access to the full text, the raw data and the `R` codes for reproducing the analysis and results in an article from a masters research conducted in the  [Epidemiology Lab](http://www.dfp.ufv.br/epidemiology) which was published in Plant Disease [(Machado et al. 2017)](http://apsjournals.apsnet.org/doi/abs/10.1094/PDIS-03-17-0340-RE). 
